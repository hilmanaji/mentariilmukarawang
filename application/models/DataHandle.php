...
class DataHandle extends CI_Model {
    ...
    function getAllWhere($tabel1, $field, $where){
	...
	function get_two_o($tabel1, $tabel2, $field, $where, $where2, $order){
		$this->db->select($field);
		$this->db->from($tabel1);
		$this->db->join($tabel2, $where);
		$this->db->where($where2);
	...
	function get_four_o($tabel1, $tabel2, $tabel3, $tabel4, $field, $where, $where2, $where3, $where4, $where5, $order ){
		$this->db->select($field);
		$this->db->from($tabel1);
		$this->db->join($tabel2, $where);
		$this->db->join($tabel3, $where2);
