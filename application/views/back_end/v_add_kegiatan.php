                                    ...
                                    <form enctype="multipart/form-data" action="<?php echo base_url() ?>Kegiatan/add" method="post" class="form-horizontal row-fluid">
                                     ...
                                     ?>        
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="nama_kegiatan" required oninvalid="this.setCustomValidity('Nama tidak boleh kosong')" oninput="setCustomValidity('')"> 
                                        </div> 
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Deskripsi</label>
                                            <textarea class="textarea_editor form-control" name="deskripsi_kegiatan" rows="10"  placeholder="Deskripsi Kegiatan ..." required oninvalid="this.setCustomValidity('Isi tidak boleh kosong')" oninput="setCustomValidity('')" ></textarea>
                                        </div>
                                        <div class="form-group">
